...
export default function DetailedCertification() {
    ...
    const handleBuy = () => {
        alert(`Bought voucher for ${certification?.testTitle || "this certification"}`);
    };
        ...
        <div className="detailed_certification">
            <ul>
                <li>
                    ...
                    <p className="skill-level">Skill level: {certification.skillLevel || "N/A"}</p>
                    <p className="duration">Duration: {certification.duration || "N/A"}</p>
