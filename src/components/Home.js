    ...
    <div className="my-home-main">
      <div className="my-home">
        ...
        <p className="main-text">
          ...
          mission is to provide individuals with the tools they need to advance
          in the tech industry by offering high-quality, industry-recognized
          certifications in programming languages like C#, JavaScript, Python,
          and more. Whether you're just starting your programming journey or
          you're a seasoned developer looking to enhance your skill set,
          Certification Shop offers a wide range of exams designed to validate
          your expertise and help you stand out in the competitive tech
          landscape. Join thousands of learners who trust Certification Shop for
          their professional development. Start your certification journey with
