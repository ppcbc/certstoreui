...
function DeleteExamCategory() {
    ...
    async function onSubmit(e) {
        ...
        try {
            ...
            var response = await axios.delete(http + `api/ExamCategories/${selectedCategory}`, {
                headers: {
                    Authorization: "Bearer " + myToken
                }
            });
    ...
    function validate() {
        let tempErrors = {};
        if (!selectedCategory) tempErrors.selectedCategory = "Please select a category";
                ...
                <div className="delete-exam-category">
                    <div className="delete-box-ExCate">
                        ...
                        {errors.selectedCategory && (
                            <p className="DeleteExamCategory-error-message">{errors.selectedCategory}</p>
                        )}
                        <div className="delete-my-inner-box-ExCate">
                        ...
                        <div className="delete-my-label-ExCate">{check && <p>{message}</p>}</div>
                    </div>
                </div>
            </form>
